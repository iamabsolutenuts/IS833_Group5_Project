...
#Attempt to translate the generated results into another language
...
languages = {'Hindi': 'Hindi', 'Arabic': 'Arabic', 'Spanish': 'Spanish', 'French': 'French'}
selected_language = st.selectbox("Select Language for Translation", list(languages.keys()))
translate_option = st.checkbox("Translate Answer")
